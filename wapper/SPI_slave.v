...
//Assertion for WRITE or READ_ADD mode (normal operations, 13-cycle transaction)
...
// Assertion for READ_DATA mode (extended 23-cycle transaction)
a_ssn_rxvalid_read: cover property (@(posedge clk) disable iff(!rst_n)
